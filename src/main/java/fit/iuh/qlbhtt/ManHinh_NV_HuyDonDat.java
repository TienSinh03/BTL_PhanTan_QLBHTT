...
public class ManHinh_NV_HuyDonDat extends javax.swing.JPanel {
     ...
     */
    public ManHinh_NV_HuyDonDat() throws SQLException {
...
//      Lần đầu chạy chương trình, load dữ liệu vào bảng
     ...
     */
     public void docDuLieuPhieuDatHang() {
     ...
     public void xuLyXoaCTPhieuDatHang(long maPDT){
...
//         }
      ...
      */
     public void xuLyXoaPhieuDatHang() {
         int row = tbl_PhieuDatHang.getSelectedRow();
         if(row!=-1) {
