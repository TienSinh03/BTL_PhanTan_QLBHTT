...
//        connect.connect();
     ...
     *
     */
    private void tblThongKeTop5KhachHangDoanhThu() {
        dtm.setRowCount(0);
     ...
     */
    private void tblThongKeTop5KhachHangThuongXuyenMuaHang() {
        dtm.setRowCount(0);
     ...
     */
    private void tblThongKeTop5KhachHangCoSLMuaNhieuNhat() {
        dtm.setRowCount(0);
