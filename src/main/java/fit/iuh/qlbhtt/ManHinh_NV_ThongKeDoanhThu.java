...
//        connect.connect();
    ...
    private void loadDanhSachSanPhamTheoThoiGian() throws ParseException {
        clearTable();
        String phanLoai = cmb_PhanLoai.getSelectedItem().toString();
        String ktPhanLoai = cmb_PhanLoai.getSelectedItem().toString();
        if (ktPhanLoai.equalsIgnoreCase("Tất cả")) {
    ...
    private void loadDanhSachSanPhamTheoThangNam() {
        clearTable();
    ...
    private void tblTop5SanPhamDoanhThuCaoNhat() {
        clearTable();
    ...
    private void tblTop5SanPhamDoanhThuThapNhat() {
        clearTable();
    ...
    private void cmb_KichThuocItemStateChanged(java.awt.event.ItemEvent evt) throws ParseException {//GEN-FIRST:event_cmb_KichThuocItemStateChanged
    ...
    private void cmb_MauSacItemStateChanged(java.awt.event.ItemEvent evt) throws ParseException {//GEN-FIRST:event_cmb_MauSacItemStateChanged
        if (chk_TatCa.isSelected()) {
            loadDanhSachSanPham();
        } else if (!chk_TatCa.isSelected()) {
            loadDanhSachSanPhamTheoThoiGian();
    ...
    private void cmb_PhanLoaiItemStateChanged(java.awt.event.ItemEvent evt) throws ParseException {//GEN-FIRST:event_cmb_PhanLoaiItemStateChanged
        if (chk_TatCa.isSelected()) {
            loadDanhSachSanPham();
        } else if (!chk_TatCa.isSelected()) {
            loadDanhSachSanPhamTheoThoiGian();
    ...
    private void dch_TuNgayPropertyChange(java.beans.PropertyChangeEvent evt) throws ParseException {//GEN-FIRST:event_dch_TuNgayPropertyChange
        if (!dieuKienTuNgay()) {
            return;
        }
        if (chk_TatCa.isSelected()) {
    ...
    private void dch_DenNgayPropertyChange(java.beans.PropertyChangeEvent evt) throws ParseException {//GEN-FIRST:event_dch_DenNgayPropertyChange
        if (!dieuKienDenNgay()) {
            return;
        }
        if (chk_TatCa.isSelected()) {
    ...
    private void chk_TatCaItemStateChanged(java.awt.event.ItemEvent evt) throws ParseException {//GEN-FIRST:event_chk_TatCaItemStateChanged
        if (chk_TatCa.isSelected()) {
            loadLaiGiaTriBanDau();
            loadDanhSachSanPham();
    ...
    private void cmb_ThangLapItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmb_ThangLapItemStateChanged
        cmb_KichThuoc.setSelectedIndex(0);
        cmb_MauSac.setSelectedIndex(0);
        cmb_PhanLoai.setSelectedIndex(0);
        dch_TuNgay.setDate(Calendar.getInstance().getTime());
    ...
    private void cmb_NamLapItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmb_NamLapItemStateChanged
        cmb_KichThuoc.setSelectedIndex(0);
        cmb_MauSac.setSelectedIndex(0);
        cmb_PhanLoai.setSelectedIndex(0);
        dch_TuNgay.setDate(Calendar.getInstance().getTime());
