...
//        connect.connect();
    ...
    private void btn_TaoNgauNhienActionPerformed(java.awt.event.ActionEvent evt) throws RemoteException {//GEN-FIRST:event_btn_TaoNgauNhienActionPerformed
        xuLyThemKHNgauNhien();
    ...
    public void xuLyThemKhachHang() throws RemoteException {
        if (!isValidateData()) {
            return;
        }
        String gt = "";
    ...
    public void xuLyCapNhatKhachHang() throws RemoteException {
        if (!isValidateData()) {
            return;
        }
        String gt="";
